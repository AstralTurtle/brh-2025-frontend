    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      <div className="flex min-h-screen w-full flex-col bg-gradient-to-b from-violet-600 to-indigo-600">
        ...
        <div className="flex w-full flex-1 flex-row gap-12 p-12">
          <div className="flex basis-2/3 flex-col gap-12 text-white">
            <h2 className="text-balance text-9xl font-extrabold text-white">Level up your game.</h2>
            <div className="flex w-full flex-row gap-4">
              <div className="flex w-full basis-1/3 flex-col gap-4 rounded-lg bg-zinc-900 p-6">
              ...
              <div className="flex w-full basis-1/3 flex-col gap-4 rounded-lg bg-zinc-900 p-6">
                ...
                <h3 className="text-balance text-5xl font-bold">Build your game.</h3>
            ...
            <button className="flex w-1/4 flex-col items-center rounded-full bg-white py-4 text-3xl font-semibold text-black">
